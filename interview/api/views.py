...
from .serializers import (
    TopicSerializer, QuestionSerializer, QuestionDetailSerializer,
...
class QuestionViewSet(viewsets.ModelViewSet):
    queryset = Question.objects.select_related('topic', 'created_by', 'updated_by').all()
    ...
    def statistics(self, request):
        ...
        for difficulty, _ in Question.DIFFICULTY_CHOICES:
            count = Question.objects.filter(difficulty=difficulty, is_active=True).count()
